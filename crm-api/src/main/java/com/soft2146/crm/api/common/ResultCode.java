...
public enum ResultCode {
    ...
    USER_IS_FOUND(20010, "用户名重复"),
    USER_NO_AUTH(20019, "用户权限不足"),
    USER_TOKEN_EXPIRES(200010, "Token已过期"),
    USER_AUTH_ERROR(200011, "用户认证失败"),


    USER_DEP_ERROR(200012, "用户已存在部门"),
    USER_PLAN_FOUND(200013, "用户已存在重复计划"),
    NAME_IS_FOUND(200014, "命名重复"),
    ...
    /* 商品错误：80001-89999 */
    PRODUCT_REPERTORY_INSUFFICIENT(80001, "商品库存不足"),
    PRODUCT_NOT_FOUNT(80002, "商品不存在"),
    CUSTOMER_CREDIT_LOW(80003, "客户信用度过低,无法下单"),
    ORDER_NOT_FOUNT(80004, "订单不存在");
